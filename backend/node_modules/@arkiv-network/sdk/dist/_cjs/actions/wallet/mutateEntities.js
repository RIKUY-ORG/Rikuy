...
exports.mutateEntities = mutateEntities;
const arkivTransactions_1 = require("../../utils/arkivTransactions");
...
async function mutateEntities(client, data, txParams) {
    ...
    const txData = (0, arkivTransactions_1.opsToTxData)({
        creates: data.creates ?? [],
        updates: data.updates ?? [],
        deletes: data.deletes ?? [],
        extensions: data.extensions ?? [],
    });
    const receipt = await (0, arkivTransactions_1.sendArkivTransaction)(client, txData, txParams);

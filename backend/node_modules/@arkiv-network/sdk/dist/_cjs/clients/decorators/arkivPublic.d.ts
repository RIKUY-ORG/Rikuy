...
import type { OnEntityCreatedEvent, OnEntityDeletedEvent, OnEntityExpiredEvent, OnEntityExpiresInExtendedEvent, OnEntityUpdatedEvent } from "../../types/events";
export type PublicArkivActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = Pick<PublicActions<transport, chain, account>, "getBalance" | "getBlock" | "getBlockNumber" | "getChainId" | "getLogs" | "getTransaction" | "getTransactionCount" | "getTransactionReceipt" | "waitForTransactionReceipt" | "watchEvent"> & {
    /**
    ...
    subscribeEntityEvents: ({ onError, onEntityCreated, onEntityUpdated, onEntityDeleted, onEntityExpiresInExtended, }: {
...
export declare function publicArkivActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined>(client: Client<transport, chain, account>): {
    getEntity: (key: Hex) => Promise<Entity>;
    query: (rawQuery: string) => Promise<Entity[]>;
    buildQuery: () => QueryBuilder;
    getBlockTiming: () => Promise<{
        currentBlock: bigint;
        currentBlockTime: number;
    ...
    getEntityCount: () => Promise<number>;
    subscribeEntityEvents: ({ onError, onEntityCreated, onEntityUpdated, onEntityDeleted, onEntityExpired, onEntityExpiresInExtended, }: {
        onError?: (error: Error) => void;
        onEntityCreated?: (event: OnEntityCreatedEvent) => void;
        onEntityUpdated?: (event: OnEntityUpdatedEvent) => void;
        onEntityDeleted?: (event: OnEntityDeletedEvent) => void;
...
//# sourceMappingURL=arkivPublic.d.ts.map
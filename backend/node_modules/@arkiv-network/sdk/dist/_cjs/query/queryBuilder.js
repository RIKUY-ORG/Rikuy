...
class QueryBuilder {
     ...
     */
    async fetch() {
        const queryResult = await (0, engine_1.processQuery)(this._client, {
        ...
        const entities = await Promise.all(queryResult.data.map((entity) => (0, entities_1.entityFromRpcResult)(entity)));
        this.cursor(queryResult.cursor);
        this.validAtBlock(queryResult.blockNumber);
        return new queryResult_1.QueryResult(entities, this, this._cursor, this._limit, this._validAtBlock);
    }
    /**

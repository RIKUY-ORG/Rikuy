import type { Account, Address, Chain, Client, ParseAccount, Prettify, PublicClientConfig, RpcSchema, Transport } from "viem";
import type { ArkivRpcSchema } from "../types/rpcSchema";
import { type PublicArkivActions } from "./decorators/arkivPublic";
export type PublicArkivClient<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, accountOrAddress extends Account | undefined = undefined, rpcSchema extends RpcSchema | undefined = ArkivRpcSchema> = Prettify<Client<transport, chain, accountOrAddress, rpcSchema, PublicArkivActions<transport, chain>>>;
/**

import type { Account, Address, Chain, Client, ParseAccount, Prettify, RpcSchema, Transport, WalletClientConfig } from "viem";
import type { ArkivRpcSchema } from "../types/rpcSchema";
import { type WalletArkivActions } from "./decorators/arkivWallet";
export type WalletArkivClient<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, rpcSchema extends RpcSchema | undefined = ArkivRpcSchema> = Prettify<Client<transport, chain, account, rpcSchema, WalletArkivActions<transport, chain, account>>>;
/**

...
exports.isKnownWasmModuleRoot = exports.getConsensusReleaseByWasmModuleRoot = exports.getConsensusReleaseByVersion = void 0;
...
function getConsensusReleaseByVersion(consensusVersion) {
    const consensusRelease = consensusReleases
        //
        .find((release) => release.version === consensusVersion);
    return consensusRelease;
}
exports.getConsensusReleaseByVersion = getConsensusReleaseByVersion;
function getConsensusReleaseByWasmModuleRoot(wasmModuleRoot) {
    const consensusRelease = consensusReleases
        //
        .find((release) => release.wasmModuleRoot === wasmModuleRoot);
    return consensusRelease;
}
exports.getConsensusReleaseByWasmModuleRoot = getConsensusReleaseByWasmModuleRoot;
function isKnownWasmModuleRoot(wasmModuleRoot) {
    return (consensusReleases.map((release) => release.wasmModuleRoot)
        //
        .includes(wasmModuleRoot));
}
exports.isKnownWasmModuleRoot = isKnownWasmModuleRoot;

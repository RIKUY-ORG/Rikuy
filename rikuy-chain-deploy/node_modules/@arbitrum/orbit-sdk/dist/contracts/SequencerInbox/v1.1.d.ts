export declare const sequencerInboxABI: readonly [{
    ...
    readonly name: "AlreadyValidDASKeyset";
    readonly type: "error";
}, {
    readonly inputs: readonly [{
    ...
    readonly name: "BadSequencerNumber";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "DataNotAuthenticated";
    readonly type: "error";
}, {
    readonly inputs: readonly [{
        readonly internalType: "uint256";
    ...
    readonly name: "DataTooLarge";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "DelayedBackwards";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "DelayedTooFar";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "ForceIncludeBlockTooSoon";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "ForceIncludeTimeTooSoon";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    ...
    readonly inputs: readonly [];
    readonly name: "IncorrectMessagePreimage";
    readonly type: "error";
}, {
    readonly inputs: readonly [{
        readonly internalType: "bytes32";
    ...
    readonly name: "NoSuchKeyset";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "NotBatchPoster";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "NotForked";
    readonly type: "error";
}, {
    readonly inputs: readonly [];
    readonly name: "NotOrigin";
    readonly type: "error";
}, {
    readonly inputs: readonly [{
    ...
    readonly inputs: readonly [{
        ...
        readonly indexed: false;
        readonly internalType: "struct ISequencerInbox.TimeBounds";
        readonly name: "timeBounds";
        readonly type: "tuple";
    }, {
        readonly indexed: false;
        readonly internalType: "enum ISequencerInbox.BatchDataLocation";
